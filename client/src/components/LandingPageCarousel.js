    ...
    <div class="carousel relative shadow-2xl bg-white">
      <div class="carousel-inner relative overflow-hidden w-full">
        ...
        <div
          ...
          style={{ height: "50vh" }}
        >
          <div class="block h-full w-full bg-indigo-500 text-5xl text-center">
            Slide 1
          </div>
        </div>
        <label
        ...
        <div
          ...
          style={{ height: "50vh" }}
        >
          <div class="block h-full w-full bg-orange-500 text-5xl text-center">
            Slide 2
          </div>
        </div>
        <label
        ...
        <div class="carousel-item absolute opacity-0">
          <div class="block h-full w-full bg-green-500 text-5xl text-center">
            Slide 3
          </div>
        </div>
        <label
        ...
        <ol class="carousel-indicators">
          <li class="inline-block mr-3">
            <label
              for="carousel-1"
              class="carousel-bullet cursor-pointer block text-4xl  hover:text-blue-700"
            >
              •
            </label>
          </li>
